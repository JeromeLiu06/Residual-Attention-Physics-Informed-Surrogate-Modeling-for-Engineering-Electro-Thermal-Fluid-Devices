...
DTYPE = torch.float32
CASE_NAME = "Case10_boundary_internal_farfield_PINN"
...
OUT_DIR = "outputs_case10_pinn_mms_ns_2d_autosave"
...
class PINN(nn.Module):
    def __init__(self, in_dim: int = 2, hidden_dim: int = 128, depth: int = 6, out_dim: int = 5):
        super().__init__()
